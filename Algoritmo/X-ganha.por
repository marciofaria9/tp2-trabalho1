...
fazerJogada(0, 0, 'X', tabuleiro) 
fazerJogada(1, 1, 'O', tabuleiro) 
fazerJogada(1, 2, 'X', tabuleiro) 
fazerJogada(2, 0, 'O', tabuleiro)
fazerJogada(0, 2, 'X', tabuleiro)
fazerJogada(2, 2, 'O', tabuleiro)
fazerJogada(0, 1, 'X', tabuleiro)
}
