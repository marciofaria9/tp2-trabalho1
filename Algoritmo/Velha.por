...
fazerJogada(0, 0, 'X', tabuleiro,cont) 
cont++
fazerJogada(0, 2, 'O', tabuleiro,cont) 
cont++
fazerJogada(2, 0, 'X', tabuleiro,cont) 
cont++
fazerJogada(1, 0, 'O', tabuleiro,cont)
cont++
fazerJogada(1, 2, 'X', tabuleiro,cont)
cont++
fazerJogada(1, 1, 'O', tabuleiro,cont)
cont++
fazerJogada(2, 2, 'X', tabuleiro,cont)
cont++
fazerJogada(2, 1, 'O', tabuleiro,cont)
cont++
fazerJogada(0, 1, 'X', tabuleiro,cont)
cont++

}

funcao fazerJogada(inteiro linha, inteiro coluna, caracter jogada,
caracter tabuleiro[][],inteiro cont) {
...
funcao verificaVencedor(caracter tabuleiro[][], inteiro cont){
    para (inteiro i = 0; i < 3; i++){
       ...
       senao se (tabuleiro[i][0]=='X' e tabuleiro[i][1]=='X' e tabuleiro[i][2]=='X' ) {
           escreva("X venceu!\n") 
       }
